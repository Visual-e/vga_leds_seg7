...
/* Module Version: 5.7 */
/* D:\dev\lattice\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n main_pll -lang verilog -synth lse -arch xo2c00 -type pll -fin 50 -fclkop 74 -fclkop_tol 2.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 5 -lock  */
/* Thu Nov 23 22:10:35 2017 */


`timescale 1 ns / 1 ps
module main_pll (CLKI, CLKOP, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire LOCK;
